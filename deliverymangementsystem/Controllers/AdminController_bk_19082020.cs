    ...
    public class AdminController : Controller
    {
        ...
        public ActionResult rescheule(tblonbordingmaster obj, FormCollection fc)
        {
            ...
            if (obj.emp_personal_email != null)
            {
                ...
                var subline = "Last Mile Deliveries LLC (LMDL)  - Rescheduled Interview Confirmation -  " + obj.emp_interview_date.Value.ToShortDateString() + " at " + fc["emp_interview_time"] + ".";//"  for the " + obj.degination_name; ;
                                                                                                                                                                                                       //var body = "<p>Hello " + obj.emp_name + ",</p>" +
                                                                                                                                                                                                       //           "<p>This email confirms your rescheduled interview with Last Mile Deliveries LLC (LMDL), an Amazon Delivery Service Partner (DSP) for Delivery Associate position on " + obj.emp_interview_date.Value.ToShortDateString() + " at " + fc["emp_interview_time"] + ".</p>" +
                                                                                                                                                                                                       //           "<p>Please contact HR @ 732-648-4674 or hr@lastmiled.com for any questions.</p>" +
                                                                                                                                                                                                       //           "<p>We look forward to meeting with you.</p> <br />" +
                                                                                                                                                                                                       //           "<p>Thank you,</p>" +
                                                                                                                                                                                                       //           "<p>Last Mile Deliveries LLC (LMDL)   </p>" +
                                                                                                                                                                                                       //           "<p>Please do not reply to this email.</p>" +
                                                                                                                                                                                                       //           "<p>It was sent from an address that cannot accept incoming messages.</p>";
...
"<div> <img width = '400' height = '570' src ='https://lastmiled.com/wp-content/uploads/map.jpg'/> </div>";
        ...
        public ActionResult ViewMoreEmployee(int id)
        {
            ...
            try
            {
                ...
                var did = dc.tbldrivers.Find(p.d_id).emp_id;


                imgname = dc.tblonbordingmasters.Find(did).upload_linces_photo;
            }
            catch
            {
                        ...
                        for (int i = 1; i < dt.Rows.Count; i++)
                        {
                            ...
                            try
                            {
                                ...
                                if (IsExist.Count == 0)
                                {
                                    ...
                                    AddRemarks(emp_id.ToString(), Entry_Remark, "AddNewEntry");
                                    AddRemarks(emp_id.ToString(), Host + "/Admin/ApplicatinForm/" + emp_id, "AddNewEntry");
                                }
                                else
                                {
        ...
        public string updateHRcheck(int d_id, string ActionType, int? gaspin)
        {
            try
            {
                var IsExists = dc.tblridesetups.Where(w => w.d_id == d_id).ToList();
